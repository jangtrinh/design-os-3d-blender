...
from project import BUILD,ROOT,output_context,write,sha
import bpy
...
contract=json.loads((BUILD/'dimensions-contract.json').read_text())
write(out/'export-evidence.json',bind_export_evidence(contract,[out/'keyboard.glb'],ROOT,
                                                     scene_sha256=sha(source),spec_sha256=sha(BUILD/'spec.json')))
