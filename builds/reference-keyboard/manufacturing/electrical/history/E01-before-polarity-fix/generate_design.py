#!/usr/bin/env python3
"""Generate CK-001 E01 electrical authority artifacts from the frozen B layout."""
import json
...
def bom():
    ...
    return {"schema_version": 1, "design_id": "CK-001-E01", "currency": None,
        ...
        part("LED000-LED106", 107, "19-237B/R6GHBHC-C01/2T", "Everlight", "common-cathode RGB LEDs", "everlight-19-237b-c01"),
...
def main():
    ...
    netlist = {
        "schema_version": 1, "design_id": "CK-001-E01", "authority": "DESIGN_AUTHORITY_LOGICAL_NOT_ECAD",
        ...
        "rgb": {"driver": "IS31FL3741A-QFLS4-TR", "supply": "RGB_5V1", "sdb_pin": "GP28", "sdb_pulldown_ohm": 100000,
                "riset_ohm": 120000, "led_mpn": "19-237B/R6GHBHC-C01/2T", "led_topology": "common cathode to SWx",
    ...
    firmware = {"schema_version": 1, "design_id": "CK-001-E01", "mcu": "RP2040", "qmk_board": "GENERIC_RP_RP2040",
    ...
    write_new("pin-map.json", {"schema_version":1,"design_id":"CK-001-E01","mcu":"RP2040","gpio_spares":0,"pins":pin_map,
    ...
    write_new("firmware/qmk/info.json", {"keyboard_name":"CK-001 E01 development hardware contract", "manufacturer":"DESIGN:OS",
