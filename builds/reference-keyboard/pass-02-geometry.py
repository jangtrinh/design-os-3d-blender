...
from project import layout,key_rows,output_context,write,ROOT,contract_path
import bpy
import json
import controls,mechanics,switches,supports,encoders,meshkit as g
...
data=layout()
normalized=normalize_contract(json.loads(contract_path().read_text()))
